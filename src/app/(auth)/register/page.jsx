...
const roles = [
  { label: "Register as Reader", value: "user", color: "bg-[#6366f1] hover:bg-[#4f46e5]" },
  { label: "Register as Writer", value: "writer", color: "bg-[#8b5cf6] hover:bg-[#7c3aed]" },
];
    ...
    <div className="min-h-screen bg-[#0f172a] flex items-center justify-center px-4 py-10">
      <div className="bg-[#1e293b] rounded-2xl p-8 w-full max-w-md shadow-2xl border border-[#6366f1]/20">
        ...
        <div className="text-center mb-6">
          <Link href="/" className="inline-flex items-center gap-2 text-2xl font-bold text-[#6366f1]">
            <RiBookOpenLine />
            Fable
          </Link>
          <h2 className="text-white text-xl font-semibold mt-3">Create Account</h2>
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          <div>
            <label className="text-gray-300 text-sm mb-1 block">Full Name <span className="text-red-400">*</span></label>
            <input
              type="text"
              name="name"
              value={formData.name}
          ...
          <div>
            <label className="text-gray-300 text-sm mb-1 block">Email Address <span className="text-red-400">*</span></label>
            <input
              type="email"
              name="email"
          ...
          <div>
            <label className="text-gray-300 text-sm mb-1 block">Password <span className="text-red-400">*</span></label>
          ...
          <div>
            <label className="text-gray-300 text-sm mb-1 block">Confirm Password <span className="text-red-400">*</span></label>
            <div className="relative">
              <input
